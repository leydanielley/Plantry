...
class RdwcSystem {
  ...
  RdwcSystem({
    ...
    this.archived = false,
       ...
       pumpWattage = RdwcSystemConfig.validateWattage(pumpWattage),
       pumpFlowRate = RdwcSystemConfig.validateFlowRate(pumpFlowRate),
       airPumpWattage = RdwcSystemConfig.validateWattage(airPumpWattage),
       airPumpFlowRate = RdwcSystemConfig.validateFlowRate(airPumpFlowRate),
       chillerWattage = RdwcSystemConfig.validateWattage(chillerWattage),
       chillerCoolingPower = RdwcSystemConfig.validateWattage(
         chillerCoolingPower,
       ),

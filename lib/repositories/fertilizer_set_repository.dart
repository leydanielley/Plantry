...
class FertilizerSetRepository with RepositoryErrorHandler {
  final DatabaseHelper _dbHelper = DatabaseHelper.instance;

  @override
  String get repositoryName => 'FertilizerSetRepository';

  /// Alle Sets laden (neueste zuerst), inkl. Anzahl der enthaltenen Dünger
  Future<List<FertilizerSet>> findAll() {
    return handleQuery(
      operation: () async {
  ...
  Future<List<FertilizerSetItem>> findItems(int setId) {
    return handleQuery(
      operation: () async {
        final db = await _dbHelper.database;
  ...
  Future<FertilizerSet> save(String name, Map<int, double> fertilizers) {

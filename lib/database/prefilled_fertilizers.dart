...
class PrefilledFertilizers {
  static final List<Fertilizer> all = [
    ...
    Fertilizer(
      ...
      name: 'Overdrive',
      npk: '1-5-4',
      type: 'Spätblüte Booster',
    ),
    Fertilizer(
      brand: 'Advanced Nutrients',
      name: 'Voodoo Juice',
      type: 'Wurzelstimulator',
    ),
    Fertilizer(
      brand: 'Advanced Nutrients',
      name: 'Bud Candy',
      type: 'Kohlenhydrate / Geschmack',
    ),
    Fertilizer(
      brand: 'Advanced Nutrients',
      name: 'B-52',
      npk: '2-1-4',
      type: 'Vitamin B / Stressschutz',
    ),
    ...
    Fertilizer(
      ...
      name: 'Sugar Royal',
      npk: '9-0-0',
      type: 'Geschmacks-Optimierer',
    ),

    // --- BIOTABS ---
    Fertilizer(
      brand: 'BioTabs',
      name: 'BioTabs (Tabletten)',
      npk: '15-7-8',
      type: 'Langzeitdünger',
    ),
    Fertilizer(
    ...
    Fertilizer(
      ...
      npk: '24-6-12',
      type: 'Pulver Wachstum',
    ),
    Fertilizer(
      brand: 'Greenhouse',
      name: 'Powder Feeding Hybrids',
      npk: '15-7-22',
      type: 'Pulver Hybrid',
    ),
    Fertilizer(
      brand: 'Greenhouse',
      name: 'Powder Feeding Short Flowering',
      npk: '16-6-26',
      type: 'Pulver Indica',
    ),
    Fertilizer(
      ...
      name: 'BioGrow',
      npk: '7-2-4',
      type: 'Bio Pulver Wachstum',
    ),
    Fertilizer(
      brand: 'Greenhouse',
      name: 'BioBloom',
      npk: '4-9-9',
      type: 'Bio Pulver Blüte',
    ),
    ...
    Fertilizer(
      ...
      name: 'Dirty',
      npk: '0-12-15',
      type: 'Ein-Komponenten (Erde/Coco)',
    ),
    Fertilizer(
      brand: 'Veg+Bloom',
      name: 'RO/Soft',
      npk: '0-12-15',
      type: 'Ein-Komponenten (Hydro RO)',
    ),
    Fertilizer(
      brand: 'Veg+Bloom',
      name: 'Tap/Hard',
      npk: '0-12-15',
      type: 'Ein-Komponenten (Leitungswasser)',
    ),
    Fertilizer(
      brand: 'Veg+Bloom',
      name: 'VBX',
      npk: '8-15-20',
      type: 'Professional Concentrated Salt',
    ),
    Fertilizer(
      brand: 'Veg+Bloom',
      name: 'Shine',

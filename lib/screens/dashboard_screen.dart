    ...
    try {
      ...
      if (plants.isNotEmpty) {
        ...
        for (int i = 0; i < plants.length; i++) {
          ...
          if (log == null ||
              DateTime.now().difference(log.logDate).inHours >= 48) {
      ...
      AppLogger.error('DashboardScreen', 'Failed to load data', e);
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: DT.accent.withValues(alpha: 0.025),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      _t['plants_without_log'].replaceAll(
                                        '{count}',
                                        '${_inactivePlants.length}',
                                      ),
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '$_plantCount ${_t['plants'].toUpperCase()}',
                                      style: const TextStyle(
                                        fontSize: 20,
                  ...
                  PlantryPremiumCard(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Spacer(),
                        Text(
                          'v${AppVersion.versionWithoutBuild}',
                          style: const TextStyle(
                            fontSize: 10,
                            color: DT.textTertiary,
                          ),
          ...
          content: SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (ctx, i) => ListTile(
                ...
                onTap: () => Navigator.pop(ctx, plants[i].id),
              ),
            ),
          ),
        ),
    ...
    final Plant? selected = await showModalBottomSheet<Plant>(
      ...
      shape: const RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(
          top: Radius.circular(DT.radiusCard),
        ),
      ),

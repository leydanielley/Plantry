...
class AppVersion {
  ...
  /// Beispiel: "0.8.7+13"
  static const String version = '0.8.7+13';
  ...
  static int compareTo(String otherVersion) {
    final thisParts = version.split('+')[0].split('.').map(int.parse).toList();
    final otherParts = otherVersion.split('+')[0].split('.').map(int.parse).toList();
